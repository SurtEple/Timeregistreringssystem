...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
                ...
                <td class="modal-sm" style="width: 290px; height: 57px">
                    <asp:TextBox ID="dateStopTextBox2" runat="server" Height="28px" CssClass="input-sm">Klikk her</asp:TextBox>
    ...
    <br />
    <asp:DropDownList ID="ddlSlettOppgave" runat="server" DataSourceID="SqlDataSourceSlettOppgave" DataTextField="Tittel" DataValueField="ID"></asp:DropDownList>
    ...
    <table>
        <tr>
            <td>* Velg oppgave: </td>
            <td><asp:DropDownList ID="ddlRedigereOppgave" runat="server" DataSourceID="SqlDataSourceRedigereOppgave" DataTextField="Tittel" DataValueField="ID" AutoPostBack="True" OnSelectedIndexChanged="ddlRedigereOppgave_SelectedIndexChanged"></asp:DropDownList>
        ...
        <tr>
            ...
            <td><asp:TextBox ID="tbxNyTittel" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>* Velg ny beskrivelse: </td>
            <td><asp:TextBox ID="tbxNyBeskrivelse" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>* Nytt tidsestimat: </td>
            <td><asp:TextBox ID="tbxNyEstimertTid" runat="server" TextMode="Number"></asp:TextBox></td>
        </tr>
        <tr>
            <td>* Brukt tid: </td>
            <td><asp:TextBox ID="tbxNyBruktTid" runat="server" TextMode="Number"></asp:TextBox></td>
        </tr>
        <tr>
                <td class="auto-style7" style="width: 161px; height: 57px">* Ny slutt dato: </td>
                <td class="modal-sm" style="width: 290px; height: 57px">
                    <asp:TextBox ID="tbxNySluttDato" runat="server" Height="28px" CssClass="input-sm">Klikk her</asp:TextBox>
