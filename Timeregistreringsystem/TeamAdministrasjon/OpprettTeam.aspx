...
<asp:Content ID="OpprettTeamContent" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <p> Navn&nbsp; </p>
        <asp:TextBox ID="tbNavn" runat="server" Height="20px" Width="200px" CssClass="input-sm"></asp:TextBox>
        ...
        <asp:DropDownList ID="ddlTeamleder" runat="server" Height="20px" Width="200px" DataSourceID="SqlDataSource1" DataTextField="Navn" DataValueField="ID" CssClass="dropdown">
        </asp:DropDownList>
        ...
        <asp:Button ID="btnAvbryt" runat="server" OnClick="btnAvbryt_Click" Text="Avbryt" Width="80px" Height="28px" CssClass="btn" />

        <asp:Button ID="btnLagreNyttTeam" runat="server" Text="Lagre" OnClick="btnLagreNyttTeam_Click" Width="80px" Height="29px" CssClass="btn" />
