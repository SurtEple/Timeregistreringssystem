...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlVelgTeam" runat="server" DataSourceID="SqlDataSourceDDLVelgTeam" DataTextField="Beskrivelse" DataValueField="ID" AppendDataBoundItems="true">
            ...
            <td>
                <asp:Button ID="btnTeamBekreft" runat="server" Text="Bekreft" OnClick="btnTeamBekreft_Click" />
            </td>
        </tr>
        ...
        <tr>
         ...
         <tr>
             ...
             <td style="height: 100px">
                <asp:DropDownList ID="ddlVelgProsjekt" runat="server" DataSourceID="SqlDataSourceDDLVelgProsjekt" DataTextField="Navn" DataValueField="ID" AppendDataBoundItems="true">
             ...
             <td style="height: 100px">
                 <asp:Button ID="btnProsjektBekreft" runat="server" Text="Bekreft" OnClick="btnProsjektBekreft_Click"  />
             </td>
        </tr>
        ...
        <tr>
            <td style="width: 352px" class="modal-sm">
                <asp:Label ID="lblVelgHovedoppgave" runat="server" Text="Velg oppgaven du vil jobbe med i dag"></asp:Label>
            </td>
            <td>
                <asp:DropDownList ID="ddlVelgHovedoppgave" runat="server" DataSourceID="SqlDataSourceVelgHovedoppgave" DataTextField="Tittel" DataValueField="ID" AppendDataBoundItems="true">
            ...
            <td>
                <asp:Button ID="btnHovedoppgaveBekreft" runat="server" Text="Bekreft" OnClick="btnHovedoppgaveBekreft_Click" />
            </td>
        </tr> 
