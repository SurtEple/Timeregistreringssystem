...
<br />
  ...
  <table>
            <tr>
                <td class="auto-style7" style="width: 273px; height: 35px">Velg prosjektet som denne fasen skal tilhøre: </td>
            ...
            <tr>
                <td class="auto-style7" style="width: 273px; height: 58px">Fasenavn:</td>
              ...
              <tr>
                <td class="auto-style7" style="width: 273px; height: 53px">Dato Start</td>
        ...
        <tr>
                <td class="auto-style7" style="width: 273px; height: 57px">Dato Slutt</td>
          ...
          <tr>
                <td class="auto-style7" style="width: 273px; height: 91px">Beskrivelse: 
                    <br />
                </td>
                <td class="modal-sm" style="width: 290px; height: 91px">
                <asp:TextBox ID="beskrivelseTextBox" runat="server" Height="181px" TextMode="MultiLine" CssClass="input-lg" Width="290px"></asp:TextBox>
                    <br />
                </td>
            </tr>
    ...
    <asp:SqlDataSource ID="SqlDataSourceFaser" runat="server" 
        ...
        SelectCommand="SELECT Fase.ID, Fase.Navn, Fase.Prosjekt_ID AS ProsjektID, Prosjekt.Navn AS ProsjektNavn, DATE_FORMAT(Fase.Dato_startet , '%Y-%m-%d') AS &quot;StartDato&quot;, DATE_FORMAT(Fase.Dato_sluttet , '%Y-%m-%d') AS &quot;SluttDato&quot;, Fase.Aktiv, Fase.Beskrivelse FROM Fase INNER JOIN Prosjekt ON Fase.Prosjekt_ID = Prosjekt.ID WHERE Fase.Prosjekt_ID &gt; 0 ORDER BY Prosjekt.ID DESC" 
