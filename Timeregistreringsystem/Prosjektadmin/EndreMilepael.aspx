...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Milepæler</h1>
    <div>
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" CssClass="table" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID,ProsjektID">
            <Columns>
    ...
    <div>
        <h1>Endre milepæl</h1>
        <p>
            <asp:DropDownList ID="DropDownListEditProsjekt" runat="server" DataSourceID="SqlDataSource1" DataTextField="ProsjektNavn" DataValueField="ProsjektID" Height="34px" Width="157px" AutoPostBack="True" CssClass="dropdown">
            </asp:DropDownList>
        </p>
        <table>
            <tr>
            ...
            <tr>
                <td class="auto-style6" style="height: 107px">Ny oppsummering: </td>
                <td class="auto-style5" style="height: 107px; width: 300px;">
        ...
        <br />
        <asp:Button ID="btnLagreNewMilestone" runat="server" Text="Lagre" Width="103px" Height="36px" CssClass="btn" OnClick="btnLagreNewMilestone_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
